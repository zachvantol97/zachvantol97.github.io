      ...
      <div className="container mx-auto text-center">
        ...
        <SplitSection
          primarySlot={
            <>
              <div className="lg:pr-32 xl:pr-48">
                <p className="mt-8 text-l font-light leading-relaxed">Zachary Van Tol is the founder of
                  ...
                  University’s School of Sustainability.</p>
              </div>
              <div className="lg:pr-32 xl:pr-48">
                <p className="mt-8 text-l font-light leading-relaxed">Zach founded Happenstance to
                  seamlessly integrate networking into
                  everyday life, believing technology
                  should enhance, not replace,
                  in-person communication.</p>
              </div>
            </>
          }
          secondarySlot={
